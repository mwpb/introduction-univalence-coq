...
makefile.conf: 
	coq_makefile -o makefile category.v categorySolutions.v equivalences.v equivalencesDefinitions.v equivalencesSolutions.v inductionAndFunctions.v inductionAndFunctionsSolutions.v lemmas.v lemmasSolutions.v productStrictlyAssoc.v productStrictlyAssocSolutions.v products.v productsSolutions.v propositionsSets.v propositionsSetsSolutions.v univalence.v univalenceSolutions.v yoneda.v yonedaSolutions.v
